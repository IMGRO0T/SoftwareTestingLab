...
class TC31(unittest.TestCase):
    ...
    def test_t_c31(self):
        ...
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Toggle navigation'])[1]/following::i[2]").click()
        ...
        driver.find_element_by_id("newpassword").send_keys("2")
        driver.find_element_by_id("confirmpassword").click()
        driver.find_element_by_id("confirmpassword").clear()
        driver.find_element_by_id("confirmpassword").send_keys("2")
