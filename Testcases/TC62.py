...
class TC01(unittest.TestCase):
    ...
    def test_t_c01(self):
        ...
        driver.find_element_by_id("emailid").send_keys("test@gmail.com")
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Sign Up'])[1]/following::input[4]").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Email available for Registration .'])[1]/following::input[1]").clear()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Email available for Registration .'])[1]/following::input[1]").send_keys(
            "1")
