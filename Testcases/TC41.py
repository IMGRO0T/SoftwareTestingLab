...
class TC41(unittest.TestCase):
    ...
    def test_t_c41(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password Recovery'])[1]/following::input[1]").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password Recovery'])[1]/following::input[1]").clear()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password Recovery'])[1]/following::input[1]").send_keys("test1212@gmail.com")
        driver.find_element_by_name("mobile").click()
        ...
        driver.find_element_by_name("newpassword").send_keys("2")
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password Recovery'])[1]/following::input[4]").send_keys("2")
