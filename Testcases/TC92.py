...
class TC42(unittest.TestCase):
    ...
    def test_t_c42(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password Recovery'])[1]/following::input[4]").send_keys("3")
        driver.find_element_by_name("update").click()
        self.assertEqual("New Password and Confirm Password Field do not match  !!", self.close_alert_and_get_its_text())
