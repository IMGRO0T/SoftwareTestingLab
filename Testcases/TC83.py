...
class TC33(unittest.TestCase):
    ...
    def test_t_c33(self):
        ...
        driver.find_element_by_link_text("POST A TESTIMONIAL").click()
        driver.find_element_by_name("testimonial").click()
        driver.find_element_by_name("testimonial").clear()
        driver.find_element_by_name("testimonial").send_keys("Happy")
