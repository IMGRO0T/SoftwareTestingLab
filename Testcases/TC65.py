...
class TC15(unittest.TestCase):
    ...
    def test_t_c15(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='CNG'])[3]/following::a[1]").click()
        ...
        driver.find_element_by_name("message").send_keys("Book the Car")
